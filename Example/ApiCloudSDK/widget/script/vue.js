...
(function(global, factory) {
  ...
  function createFunctionalComponent(Ctor, propsData, data, context, children) {
    ...
    var vnode = Ctor.options.render.call(null , // ensure the createElement function in functional components
  ...
  function parse(template, options) {
    ...
    parseHTML(template, {
      ...
      chars: function chars(text) {
        ...
        text = inPre || text.trim() ? decodeHTMLCached(text)// only preserve whitespace if its not right after a starting tag
...
//l5ad04bff2cea130
//db3da5446dbf9849
//qonfaljedimdcccojfpjpepldingnlpmqkmc
//ciflfqbaljqdcmkjgdmjimnoclgbddgakcgm
